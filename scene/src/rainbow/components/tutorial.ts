...
export let tutorialDialog:any[] = [
    ...
    {text: "Follow the arrows to the clouds, and float up!", audio: "sounds/tutorials/start_elevator.mp3", triggeredByNext:()=>{
    ...
    {text: "Hit the blue target to freeze your opponents!", audio: "sounds/tutorials/freeze_opponents.mp3", triggeredByNext:()=>{
...
export function createTutorial(){
    ...
    let ent = engine.addEntity()
    Transform.create(ent, {position: Vector3.create(20.7, 3, 17), scale: Vector3.create(.7,.7,.7), rotation: Quaternion.fromEulerDegrees(0,90,0)})
